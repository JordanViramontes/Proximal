...
func bene_initialize(starting_position, init_player_position, init_spawn_direction, init_wave, init_health_multiplier, init_xp_multiplier):
	# spawning
	super.initialize(starting_position, init_player_position, init_wave, init_health_multiplier, init_xp_multiplier)
