...
var SE_player_category: String = "player"
...
func kill_player():
	...
	# sounds
	sound_effect_signal.emit(SE_player_category, SE_player_dies)
...
func on_damaged(di: DamageInstance):
	# sounds
	sound_effect_signal.emit(SE_player_category, SE_player_gets_damaged)
